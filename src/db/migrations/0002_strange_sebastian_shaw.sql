...
ALTER TABLE "courses" ADD COLUMN "discount" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "courses" ADD COLUMN "information" text;--> statement-breakpoint
